...
namespace Lexic
{
    public class ProfileNameGenerator : MonoBehaviour
    {

        private string namesSourceClass;

        public string[] nameSourceClasses;
        ...
        void AdjustNameGenSourceClass(string newSourceClassName)
        {
            newSourceClassName = "Lexic." + newSourceClassName;
            if (newSourceClassName == namesSourceClass) return;

            namesSourceClass = newSourceClassName;
        ...
        public string GetNextRandomName(string gender = null)
        {
            ...
            AdjustNameGenSourceClass(nameSourceClasses[Random.Range(0, 2) == 0 ? 0 : 1]);
